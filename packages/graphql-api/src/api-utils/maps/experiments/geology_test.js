...
const geology_test = {
  ...
  sources: {
    openmaptiles: {
      type: 'vector',
      tiles: ['https://tile.gbif.org/3857/omt/{z}/{x}/{y}.pbf'],
    ...
    burwell: {
      type: 'vector',
      tiles: ['https://tiles.macrostrat.org/carto-slim/{z}/{x}/{y}.mvt'],
      maxzoom: 13,
      attribution: 'macrostrat.org',
      tileSize: 512,
    },
    hillshade: {
      type: 'raster',
