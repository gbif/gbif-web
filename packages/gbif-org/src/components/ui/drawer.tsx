  ...
  <DrawerPortal>
    <div className="gbif">
      ...
      <DrawerPrimitive.Content
        ref={ref}
        className={cn('g-fixed g-inset-x-0 g-bottom-0 g-z-50 g-mt-24 g-flex g-h-auto g-flex-col g-rounded-t-[10px] g-border g-bg-background',
          className
        )}
        {...props}
      >
...
const DrawerFooter = ({
  ...
  <div
    className={cn('g-mt-auto g-flex g-flex-col g-gap-2 g-p-4', className)}
    {...props}
  />
)
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Title
    ref={ref}
    className={cn('g-text-lg g-font-semibold g-leading-none g-tracking-tight',
      className
    )}
    {...props}
  />
