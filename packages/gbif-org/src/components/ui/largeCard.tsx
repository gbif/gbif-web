...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('g-rounded g-border g-bg-card g-text-card-foreground g-scroll-mt-24 g-shadow-[0_10px_40px_-12px_rgba(0,0,0,0.1)]',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('g-flex g-flex-col g-space-y-1.5 g-p-4 md:g-p-8', className)}
    {...props}
  />
))
