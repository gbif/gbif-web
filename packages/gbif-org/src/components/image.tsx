...
export function ClientImage({
  ...
  return (
    <div style={{ display: 'inline-block', ...style }}>
      {loading && (
        <div
          className="g-animate-pulse g-rounded-md g-bg-slate-50 g-text-slate-400 g-flex g-items-center g-justify-center g-me-3"
      ...
      {failed && (
        <div className="gb-image-failed g-me-3">
          <div
            style={defaultSize}
