...
export default function StaticDashboard({ predicate, charts = [] }: Props) {
  ...
  return (
    <div>
      <DashBoardLayout>{chartsToRender}</DashBoardLayout>
    </div>
  );
}
...
const lookup: Record<string, React.FC<any>> = {
  ...
  basisOfRecord: ({ predicate, ...props }) => (
    <charts.BasisOfRecord predicate={predicate} {...props} />
  ),
  year: ({ predicate, ...props }) => (
    <charts.EventDate options={['TIME']} predicate={predicate} {...props} />
  ),
  ...
  dwcaExtension: ({ predicate, ...props }) => (
    <charts.DwcaExtension predicate={predicate} {...props} />
  ),
  ...
  publishingCountryCode: ({ predicate, ...props }) => (
    <charts.PublishingCountryCode predicate={predicate} {...props} />
  ),
  protocol: ({ predicate, ...props }) => <charts.Protocol predicate={predicate} {...props} />,
  sampleSizeUnit: ({ predicate, ...props }) => (
    <charts.SampleSizeUnit predicate={predicate} {...props} />
  ),
  samplingProtocol: ({ predicate, ...props }) => (
    <charts.SamplingProtocol predicate={predicate} {...props} />
  ),
  ...
  collectionCode: ({ predicate, ...props }) => (
    <charts.CollectionCodes predicate={predicate} {...props} />
  ),
  institutionCode: ({ predicate, ...props }) => (
    <charts.InstitutionCodes predicate={predicate} {...props} />
  ),
  stateProvince: ({ predicate, ...props }) => (
    <charts.StateProvince predicate={predicate} {...props} />
  ),
  identifiedBy: ({ predicate, ...props }) => (
    <charts.IdentifiedBy predicate={predicate} {...props} />
  ),
  recordedBy: ({ predicate, ...props }) => <charts.RecordedBy predicate={predicate} {...props} />,
  establishmentMeans: ({ predicate, ...props }) => (
    <charts.EstablishmentMeans predicate={predicate} defaultOption="PIE" {...props} />
  ),
  month: ({ predicate, ...props }) => (
    <charts.Months predicate={predicate} defaultOption="PIE" {...props} />
  ),
  preparations: ({ predicate, ...props }) => (
    <charts.Preparations predicate={predicate} defaultOption="PIE" {...props} />
  ),
  ...
  occurrenceIssue: ({ predicate, ...props }) => (
    <charts.OccurrenceIssue predicate={predicate} {...props} />
  ),
  dataQuality: ({ predicate, ...props }) => <charts.DataQuality predicate={predicate} {...props} />,
  occurrenceSummary: ({ predicate, ...props }) => (
    <charts.OccurrenceSummary predicate={predicate} {...props} />
  ),
  collectionKey: ({ predicate, ...props }) => (
    <charts.Collections predicate={predicate} {...props} />
  ),
  institutionKey: ({ predicate, ...props }) => (
    <charts.Institutions predicate={predicate} {...props} />
  ),
  projectId: ({ predicate, ...props }) => <charts.ProjectId predicate={predicate} {...props} />,
  catalogNumber: ({ predicate, ...props }) => (
    <charts.CatalogNumber predicate={predicate} {...props} />
  ),
};
