  ...
  return (
    <div className="g-text-sm g-prose">
      ...
      <Card className="g-p-2 g-mb-2">
        ...
        <a
          href={`${import.meta.env.PUBLIC_API}/v1/literature`}
        >{`${import.meta.env.PUBLIC_API}/v1/literature`}</a>
      </Card>
      <Card className="g-p-2 g-mb-2">
        <FormattedMessage id="apiHelp.searchExample" /> <br />
        <a href={`${import.meta.env.PUBLIC_API}/v1/literature/search?q=dna&offset=0&limit=2`}>
          {`${import.meta.env.PUBLIC_API}/v1/literature/search?q=dna&offset=0&limit=2`}
        </a>
      </Card>
    </div>
  );
