...
export function SamplingDescription({
  ...
  return <Properties className='g-mb-2 [p]:g-mt-0' useDefaultTermWidths>
    {dataset.samplingDescription?.sampling && <>
      <Term><FormattedMessage id={`dataset.sampling`} defaultMessage="Sampling" /></Term>
      <Value><HyperText className='g-prose' text={dataset.samplingDescription.sampling} /></Value></>}
    {dataset.samplingDescription?.studyExtent && <>
      <Term><FormattedMessage id={`dataset.studyExtent`} defaultMessage="Study extent" /></Term>
      <Value><HyperText className='g-prose' text={dataset.samplingDescription.studyExtent} /></Value></>
    }
    {dataset.samplingDescription?.qualityControl && <>
      ...
      <Value><HyperText className='g-prose' text={dataset.samplingDescription.qualityControl} /></Value></>
    }
