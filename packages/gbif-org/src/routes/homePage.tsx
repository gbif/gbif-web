        ...
        <div className="prose">
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                <DynamicLink className="me-4" to="/institution/955b0e63-c3b5-4d74-8dfa-15b384b9ae77">
                  Institution
                </DynamicLink>
              </li>
              <li>
                {/* <DynamicLink className="me-4" to="/collection/e9d2c520-d9fc-4331-9ed8-73bea2b22af0"> */}
                <DynamicLink className="me-4" to="/collection/03a64ffd-34d0-432c-a152-0d41d41c028f">
                  Collection
                </DynamicLink>
              </li>
              <li>
