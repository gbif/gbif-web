...
export function WhatAndHow() {
  ...
  return (
    <>
      ...
      <p className="g-text-sm g-font-medium g-pt-4">Which types of data do you expect to publish?</p>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="g-space-y-2 g-pt-4">
            ...
            <FormControl>
              <RadioGroup onValueChange={field.onChange} className="g-flex g-flex-row g-space-x-4 g-mt-1">
                <RadioItem value="yes" label="Yes" />
                <RadioItem value="no" label="No" />
              </RadioGroup>
            </FormControl>
