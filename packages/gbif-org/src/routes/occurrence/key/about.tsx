              ...
              {hasMap && (
                <Card className="g-mb-4">
                  <HashLink to="#location" replace className="g-block g-relative g-group">
                    <img
                      src={`${import.meta.env.PUBLIC_TILE_API}/3857/gbif-geyser/static/${occurrence.coordinates.lon},${occurrence.coordinates.lat},${overviewZoom}/250x180@2x.jpg?marker=${occurrence.coordinates.lon},${occurrence.coordinates.lat}|marker-icon-2x.png|scale:0.5`}
                    />
                    <img
                      className="g-absolute g-opacity-0 g-top-0 group-hover:g-opacity-100 g-transition-opacity gb-on-hover"
                      src={`${import.meta.env.PUBLIC_TILE_API}/3857/satellite/static/${occurrence.coordinates.lon},${occurrence.coordinates.lat},${sateliteZoom}/250x180@2x.jpg?marker=${occurrence.coordinates.lon},${occurrence.coordinates.lat}|marker-icon-2x.png|scale:0.5`}
                    />
                  </HashLink>
                </Card>
              )}
