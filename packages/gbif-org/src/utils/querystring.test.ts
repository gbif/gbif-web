...
// the parse function should take the string and return an object with the key value pairs. arrays are repeated as multiple values. numbers are parsed as strings
test('parse', () => {
