...
const languageOptions: LanguageOption[] = [
  ...
  },
  {
    ...
    default: false,
    textDirection: 'rtl',
    reactIntlLocale: 'he-IL',
    vocabularyLocale: 'he-IL',
    iso3LetterCode: 'heb',
    gbifOrgLocalePrefix: '',
    grSciCollLocalePrefix: '',
    mapTileLocale: 'en',
  ...
  },
  {
    ...
    default: false,
    textDirection: 'ltr',
    reactIntlLocale: 'da-DK',
    vocabularyLocale: 'da-DK',
    iso3LetterCode: 'dan',
    gbifOrgLocalePrefix: '',
    grSciCollLocalePrefix: '',
    mapTileLocale: 'da',
  ...
  },
  {
    ...
    default: false,
    textDirection: 'ltr',
    reactIntlLocale: 'nl-NL',
    vocabularyLocale: 'nl-NL',
    iso3LetterCode: 'nld',
    gbifOrgLocalePrefix: '',
    grSciCollLocalePrefix: '',
    mapTileLocale: 'en',
  ...
  },
  {
    ...
    default: false,
    textDirection: 'ltr',
    reactIntlLocale: 'ko-KR',
    vocabularyLocale: 'ko-KR',
    iso3LetterCode: 'kor',
    gbifOrgLocalePrefix: '',
    grSciCollLocalePrefix: '',
    mapTileLocale: 'en',
  ...
  },
  {
    ...
    default: false,
    textDirection: 'rtl',
    reactIntlLocale: 'fa-IR-u-nu-latn',
    vocabularyLocale: 'fa-IR',
    iso3LetterCode: 'fas',
    gbifOrgLocalePrefix: '',
    grSciCollLocalePrefix: '',
    mapTileLocale: 'en',
