...
export type TaxonQuery = { __typename?: 'Query', taxon?: { __typename?: 'Taxon', key: number, scientificName?: string | null, kingdom?: string | null } | null };

export type TaxonSummaryMetricsQueryVariables = Exact<{ [key: string]: never; }>;


export type TaxonSummaryMetricsQuery = { __typename?: 'Query', taxonSearch: { __typename?: 'TaxonSearchResult', facet?: { __typename?: 'TaxonFacet', issue?: Array<{ __typename?: 'TaxonFacetResult', name: string, count: number } | null> | null } | null } };
...
export const TaxonDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Taxon"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"key"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"taxon"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"key"},"value":{"kind":"Variable","name":{"kind":"Name","value":"key"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"scientificName"}},{"kind":"Field","name":{"kind":"Name","value":"kingdom"}}]}}]}}]} as unknown as DocumentNode<TaxonQuery, TaxonQueryVariables>;
export const TaxonSummaryMetricsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"TaxonSummaryMetrics"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"taxonSearch"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"facet"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"issue"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"count"}}]}}]}}]}}]}}]} as unknown as DocumentNode<TaxonSummaryMetricsQuery, TaxonSummaryMetricsQueryVariables>;
