...
export type CollectionQuery = {
  ...
  collection?: {
    ...
    importantCollectors?: Array<string | null> | null;
...
export type DatasetSearchQuery = {
  ...
  list: {
    ...
    limit: number;
    offset: number;
    results: Array<{ __typename?: 'DatasetSearchStub'; key: string; title?: string | null }>;
  };
};
...
export type InstitutionSearchQuery = {
  ...
  list?: {
    __typename?: 'InstitutionSearchResults';
    results: Array<{ __typename?: 'Institution'; key: string; title?: string | null } | null>;
  } | null;
};
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'importantCollectors' } },
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'collectionSummary' } },
                {
                  kind: 'Field',
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: 'EnumValue', value: 'NUMBER_SPECIMENS' },
              },
              {
                kind: 'Argument',
