...
const documents = {
  ...
  '\n  query DatasetEvent($key: ID!, $limit: Int, $offset: Int, $eventID: ID, $optParentEventID: ID) {\n    dataset(key: $key) {\n      key\n      samplingDescription {\n        studyExtent\n        methodSteps\n        sampling\n      }\n      events(\n        key: $key\n        limit: $limit\n        offset: $offset\n        eventID: $eventID\n        optParentEventID: $optParentEventID\n      ) {\n        endOfRecords\n        results {\n          eventId\n          firstOccurrence {\n            volatile {\n              globe {\n                svg\n              }\n            }\n            countryCode\n            eventDate\n            key\n            datasetKey\n            decimalLatitude\n            decimalLongitude\n            parentEventID\n            eventID\n          }\n        }\n      }\n    }\n  }\n':
    types.DatasetEventDocument,
  '\n  query EventInsights(\n    $imagePredicate: Predicate\n    $coordinatePredicate: Predicate\n    $taxonPredicate: Predicate\n    $yearPredicate: Predicate\n    $datasetPredicate: Predicate\n  ) {\n    unfiltered: occurrenceSearch(predicate: $datasetPredicate) {\n      documents(size: 0) {\n        total\n      }\n      cardinality {\n        eventId\n      }\n      facet {\n        dwcaExtension {\n          key\n          count\n        }\n      }\n    }\n    images: occurrenceSearch(predicate: $imagePredicate) {\n      documents(size: 10) {\n        total\n        results {\n          key\n          stillImages {\n            identifier: thumbor(height: 400)\n          }\n        }\n      }\n    }\n    withCoordinates: occurrenceSearch(predicate: $coordinatePredicate) {\n      documents(size: 10) {\n        total\n      }\n    }\n    withTaxonMatch: occurrenceSearch(predicate: $taxonPredicate) {\n      documents(size: 10) {\n        total\n      }\n    }\n    withYear: occurrenceSearch(predicate: $yearPredicate) {\n      documents(size: 10) {\n        total\n      }\n    }\n  }\n':
    types.EventInsightsDocument,
  '\n  query DatasetEventList($key: ID!, $limit: Int, $offset: Int, $optParentEventID: ID) {\n    dataset(key: $key) {\n      eventCount(optParentEventID: $optParentEventID)\n      events(key: $key, limit: $limit, offset: $offset, optParentEventID: $optParentEventID) {\n        endOfRecords\n        results {\n          eventId\n          occurrenceCount\n\n          firstOccurrence {\n            key\n            eventDate\n            parentEventID\n            eventID\n            samplingProtocol\n          }\n        }\n      }\n    }\n  }\n':
    types.DatasetEventListDocument,
  ...
  '\n    query OccurrenceTaxonomicIssueFacet($q: String, $predicate: Predicate, $checklistKey: ID) {\n      search: occurrenceSearch(q: $q, predicate: $predicate) {\n        facet {\n          field: taxonomicIssue(size: 100, checklistKey: $checklistKey) {\n            name: key\n            count\n          }\n        }\n      }\n    }\n  ':
    types.OccurrenceTaxonomicIssueFacetDocument,
  ...
  '\n    query OccurrenceFieldNumberFacet($predicate: Predicate) {\n      search: occurrenceSearch(predicate: $predicate) {\n        facet {\n          field: fieldNumber(size: 10) {\n            name: key\n            count\n          }\n        }\n      }\n    }\n  ':
    types.OccurrenceFieldNumberFacetDocument,
