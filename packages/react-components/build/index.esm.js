...
import { css, jsx, keyframes, withEmotionCache, ThemeContext as ThemeContext$1 } from '@emotion/core';
import React, { useContext, useEffect, Component, useState, useRef, useCallback, createElement, Fragment } from 'react';
import 'prop-types';
...
import { MdClose, MdLock, MdLockOpen, MdFirstPage, MdChevronLeft, MdChevronRight, MdMoreVert, MdFullscreenExit, MdFullscreen, MdInfo, MdFilterList } from 'react-icons/md';
import { usePopoverState, PopoverDisclosure, PopoverBackdrop, Popover as Popover$1, PopoverArrow } from 'reakit/Popover';
import _defineProperty from '@babel/runtime/helpers/defineProperty';
import Downshift from 'downshift';
import { useDebounce } from 'use-debounce';
import camelCase from 'lodash/camelCase';
import { uncontrollable } from 'uncontrollable';
import { useMenuState, MenuButton, Menu as Menu$1, MenuItem } from 'reakit/Menu';
...
var root = function root(_ref) {
  ...
  return (
    /*#__PURE__*/
    css("font-family:BlinkMacSystemFont,-apple-system,\"Segoe UI\",\"Roboto\",\"Oxygen\",\"Ubuntu\",\"Cantarell\",\"Fira Sans\",\"Droid Sans\",\"Helvetica Neue\",\"Helvetica\",\"Arial\",sans-serif;color:", theme.color || '#4a4a4a', ";font-size:", theme.fontSize || '1em', ";font-weight:400;box-sizing:border-box;-webkit-tap-highlight-color:rgba(0,0,0,0);*,*::before,*::after,strong{box-sizing:inherit;}" + ( "" ))
  );
};
var styles = {
  root: root
...
var Root = React.forwardRef(function (_ref, ref) {
  var _ref$as = _ref.as,
  ...
  return function (WrappedComponent) {
    var Wrapper = function Wrapper(props) {
      return React.createElement(AppContext.Consumer, null, function (context) {
        return React.createElement(WrappedComponent, _extends({}, injectedProps(context), props));
      });
    };
...
var primary = function primary(theme) {
  return (
    /*#__PURE__*/
    css("background-color:", theme.colors.primary500, ";color:white;&:not([aria-disabled=\"true\"]){&:hover{color:white;border-color:", theme.colors.primary500, ";background-color:", theme.colors.primary600, ";}&:active,&[aria-expanded=\"true\"]{color:white;border-color:", theme.colors.primary600, ";background-color:", theme.colors.primary700, ";}}" + ( "" ))
  );
};
var primaryOutline = function primaryOutline(theme) {
  return (
    /*#__PURE__*/
    css("border-color:", theme.colors.primary500, ";background:none;color:", theme.colors.primary700, ";" + ( "" ))
  );
};
var outline = function outline(theme) {
  return (
    /*#__PURE__*/
    css("border-color:", theme.transparentInk40, ";background:none;" + ( "" ))
  );
};
...
var Button = React.forwardRef(function (_ref, ref) {
  ...
  var theme = useContext(ThemeContext); // const appliedTheme = isEmpty(theme) ? standardTheme : theme;
  ...
  return jsx(Button$1, _extends({
    ...
    css:
    /*#__PURE__*/
    css(styles$1.button(appliedTheme), " ", classesToApply.map(function (x) {
...
var FilterButton = React.forwardRef(function (_ref3, ref) {
...
var TextButton = React.forwardRef(function (_ref2, ref) {
  var props = _extends({}, _ref2);
...
var Switch = React.forwardRef(function (_ref2, ref) {
...
var Popover = function Popover(_ref4) {
  ...
  return jsx(React.Fragment, null, jsx(PopoverDisclosure, _extends({}, popover, trigger.props), function (disclosureProps) {
    return React.cloneElement(trigger, disclosureProps);
  }), jsx(PopoverBackdrop, _extends({}, popover, {
    css: backdrop(),
    onClick: function onClick() {
      return onClickOutside ? onClickOutside(popover) : undefined;
    }
  })), jsx(Popover$1, _extends({}, popover, props, {
    hideOnClickOutside: false,
    hideOnEsc: true
  }), function (props) {
    return popover.visible && jsx(Root, _extends({}, props, {
      css: dialog()
    }), jsx(PopoverArrow, _extends({
      className: "arrow"
    }, popover)), jsx("div", {
      css: dialogContent()
...
var before = function before(_ref2) {
  ...
  return (
    /*#__PURE__*/
    css("display:block;position:absolute;content:'';left:-200px;width:200px;height:1px;background-color:", theme.colors.primary, ";animation:", loading$1, " 1.5s linear infinite;", error ? errorStyle() : null,  "" )
  );
};
...
var StripeLoader = function StripeLoader(_ref3) {
  ...
  return jsx("div", {
    css:
    /*#__PURE__*/
    css("height:1px;width:100%;position:relative;overflow:hidden;&:before{", active ? before({
      error: error,
      theme: theme
    }) : null, "}" + ( "" ))
  });
...
var menu = function menu(props) {
  return (
    /*#__PURE__*/
    css("max-height:450px;margin:0;padding:4px 0;padding-left:0;overflow:auto;list-style:none;outline:none;", styledScrollBars(),  "" )
  );
};
var styles$3 = {
  wrapper: wrapper,
...
var Autocomplete = React.forwardRef(function (_ref, ref) {
  ...
  var _useDebounce = useDebounce(inputProps.value, 100),
  ...
  return jsx(Downshift, {
    ...
    }), jsx(Input, getInputProps(_objectSpread({
      ref: ref
    }, inputProps, {
...
var tab = function tab(_ref3) {
  ...
  return (
    /*#__PURE__*/
    css(border(3, theme.colors.primary500, direction, isActive), " display:", direction === 'left' || direction === 'right' ? 'block' : 'inline-block', ";padding:10px 10px;cursor:pointer;&:hover,&:focus{outline:none;background:rgba(0,0,0,.05);}::-moz-focus-inner{border-style:none;}" + ( "" ))
  );
};
...
var Tabs = uncontrollable(ControlledTabs, {
  activeId: 'onChange'
});
...
var row = function row(props) {
  return (
    /*#__PURE__*/
    css("display:flex;flex-direction:", props.direction || null, ";flex-wrap:", props.wrap ? props.wrap : 'wrap', ";align-items:", props.alignItems ? props.alignItems : null, ";margin:", props.halfGutter ? -props.halfGutter + 'px' : null, ";>*{padding:", props.halfGutter ? props.halfGutter + 'px' : null, ";}" + ( "" ))
  );
};
...
var getFlexSize = function getFlexSize(size, breakpoint) {
  return (
    /*#__PURE__*/
    css("@media (min-width:", breakpoint, "px){flex-basis:", size ? size * 100 / 24 + '%' : null, ";}" + ( "" ))
  );
};
...
var Menu = React.memo(function (_ref4) {
  var trigger = _ref4.trigger,
      placement = _ref4.placement,
      items = _ref4.items,
  ...
  return jsx(React.Fragment, null, jsx(MenuButton, _extends({}, menu, trigger.props), function (disclosureProps) {
    return React.cloneElement(trigger, disclosureProps);
  }), jsx(Menu$1, _extends({}, menu, props, {
    css: focus(),
    style: {
      zIndex: 999
    }
    ...
    return jsx(MenuItem, _extends({}, menu, item.props, {
      key: i
    }), function (itemProps) {
...
var MenuToggle = React.forwardRef(function (_ref5, ref) {
...
var MenuAction = React.forwardRef(function (_ref6, ref) {
...
var menuAction = function menuAction(theme) {
  return (
    /*#__PURE__*/
    css(menuOption(), ";background:none;border:none;background:none;outline:none;" + ( "" ))
  );
};
...
var skeleton = function skeleton(_ref) {
  ...
  return (
    /*#__PURE__*/
    css("width:", width, ";display:inline-block;height:1em;animation:", skeletonLoading, " 3s linear infinite;" + ( "" ))
  );
};
var styles$5 = {
  skeleton: skeleton
...
var footer = function footer(props) {
  return (
    /*#__PURE__*/
    css("height:50px;display:flex;flex-direction:row;padding:0 10px;background:#f7f9fa;border-radius:0 0 ", borderRadius, " ", borderRadius, ";" + ( "" ))
  );
};
...
var footerText = function footerText(props) {
  return (
    /*#__PURE__*/
    css(footerItemBase(), ";width:auto;font-size:12px;text-align:center;flex:1 1 auto;" + ( "" ))
  );
};
...
var Th = function Th(_ref2) {
  ...
  }, locked ? jsx(MdLock, null) : jsx(MdLockOpen, null))));
};
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      ...
      return jsx(React.Fragment, null, jsx("div", {
        ...
        tip: "first",
        onClick: first
      }, jsx(MdFirstPage, null)), page > 1 && jsx(Button, {
        appearance: "text",
        css: styles$6.footerItem(),
        direction: "right",
        tip: "previous",
        onClick: prev
      }, jsx(MdChevronLeft, null)), jsx("span", {
        css: styles$6.footerText()
      }, jsx(FormattedMessage, {
        id: "pagination.pageXofY",
        defaultMessage: 'Loading',
        values: {
          current: jsx(FormattedNumber, {
            value: page
          }),
          total: jsx(FormattedNumber, {
            value: totalPages
          })
        }
        ...
        tip: "next",
        onClick: next
      }, jsx(MdChevronRight, null)), jsx(Button, {
        appearance: "text",
        css: styles$6.footerItem(),
        direction: "left",
        tip: "options"
...
var more = function more(props) {
  return (
    /*#__PURE__*/
    css("flex:100 1 auto;display:flex;height:", props.height || 150, "px;align-items:center;color:#888;min-width:100px;padding-left:30px;" + ( "" ))
  );
...
var detailPrev = function detailPrev(props) {
  return (
    /*#__PURE__*/
    css(detailNav(), ";left:0;" + ( "" ))
  );
};
var detailNext = function detailNext(props) {
  return (
    /*#__PURE__*/
    css(detailNav(), ";right:0;" + ( "" ))
  );
};
var skeletonTile = function skeletonTile(props) {
  return (
    /*#__PURE__*/
    css("height:", props.height, "px;width:", props.height * 1.2, "px;flex:1 1 auto;margin:6px;animation:", skeletonLoading, " 3s linear infinite;" + ( "" ))
  );
};
var styles$7 = {
  gallery: gallery,
...
var image = function image(_ref3) {
  ...
  return (
    /*#__PURE__*/
    css("height:100%;width:100%;background:url(", src, ");background-position:center;background-size:contain;background-repeat:no-repeat;position:relative;text-align:center;", blur ? 'filter: blur(8px)' : '', ";" + ( "" ))
  );
};
...
var ZoomableImage = React.forwardRef(function (_ref, ref) {
  var src = _ref.src,
  ...
  var _useState3 = useState(thumbnail),
  ...
  }, isFullscreen ? jsx(MdFullscreenExit, null) : jsx(MdFullscreen, null))));
});
...
var GalleryDetails = function GalleryDetails(_ref) {
  ...
  }, jsx(MdChevronLeft, null)), item && jsx(ZoomableImage, {
    src: imageSrc(item),
  ...
  }, jsx(MdChevronRight, null))), details && jsx(React.Fragment, null, jsx(Col, {
    shrink: false,
    grow: false,
    css: detailDrawerBar
  }, jsx(TabList$1, {
...
var Gallery = function Gallery(_ref3) {
  ...
  return jsx(React.Fragment, null, !onSelect && jsx(Dialog, _extends({}, dialog, {
    tabIndex: 0,
    "aria-label": "Welcome"
...
var Option = React.forwardRef(function (_ref2, ref) {
...
var withContext$1 = function withContext() {
  ...
  return function (WrappedComponent) {
    var Wrapper = function Wrapper(props) {
      return React.createElement(FilterContext.Consumer, null, function (context) {
        return React.createElement(WrappedComponent, _extends({}, injectedProps(context), props));
      });
    };
...
function (_Component) {
  ...
  _createClass(Map, [{
    ...
    key: "render",
    value: function render() {
      return React.createElement(MapAreaComponent, null, React.createElement(MapComponent, {
        ref: this.myRef
      }));
    }
  }]);
...
var Map$1 = function Map$1(props) {
  return React.createElement(Map, props); // return <h1>test</h1>
};
  ...
  return (
    ...
    function (_Component) {
      ...
      _createClass(Format, [{
        ...
        key: "render",
        value: function render() {
          var title = this.state.error ? React.createElement("span", {
            className: "discreet"
...
var TriggerButton = React.forwardRef(function (_ref, ref) {
  ...
  var currentFilterContext = useContext(FilterContext); // const {formatMessage: f} = useIntl();
  ...
  }, props), options.length === 1 ? React.createElement(DisplayValue, {
    id: options[0]
...
var Prose = React.forwardRef(function (_ref8, ref) {
...
var prose = function prose(_ref17) {
  ...
  return (
    /*#__PURE__*/
    css("-webkit-font-smoothing:antialiased;line-height:1.3em;h1,h2,h3,h4,h5,h6{font-weight:400;}h1{", h1(theme), ";}h2{", h2(theme), ";}h3{", h3(theme), ";}h4{", h4(theme), ";}h5{", h5(theme), ";}h6{", h6(theme), ";}", ol(theme), ";p{margin-bottom:8px;}" + ( "" ))
  );
};
...
function (_React$Component) {
  ...
  return FilterState;
}(React.Component); // export default FilterState;


var UncontrollableFilterState = uncontrollable(FilterState, {
  filter: 'onChange'
});
...
function Filter(_ref) {
  var children = _ref.children,
      ...
      style = _ref.style;
  return React.createElement(UncontrollableFilterState, {
    filter: tmpFilter,
    onChange: function onChange(updatedFilter) {
      return onFilterChange(updatedFilter);
    }
  }, React.createElement(FilterContext.Consumer, null, function (_ref2) {
    ...
    return React.createElement(FilterBox, {
      ...
      menuItems: function menuItems(menuState) {
        return [].concat(_toConsumableArray(aboutText ? [React.createElement(MenuAction, {
          key: "About",
          onClick: function onClick() {
            onAboutChange(true);
            menuState.hide();
          }
        }, "About this filter")] : []), _toConsumableArray(hasHelpTexts ? [React.createElement(MenuToggle, {
          key: "Help",
    ...
    }, title), !aboutVisible && React.createElement(React.Fragment, null, children({
    ...
    })), aboutVisible && React.createElement(React.Fragment, null, React.createElement(Prose, {
      as: FilterBodyDescription
    }, aboutText), React.createElement(Footer, footerProps)));
  }));
}

var UncontrollableFilter = uncontrollable(Filter, {
...
var PopupContent = function PopupContent(_ref) {
  ...
  return jsx(UncontrollableFilter, {
    ...
    return jsx(React.Fragment, null, jsx(Suggest, _extends({}, suggestConfigs.scientificName, {
      focusRef: focusRef,
    ...
    })), options.length > 0 && jsx(React.Fragment, null, jsx(SummaryBar, _extends({}, summaryProps, {
      style: {
        marginTop: 0
      }
    })), jsx(FilterBody, {
...
var TaxonFilterPopover = function TaxonFilterPopover(_ref7) {
  ...
  var _useState5 = useState(currentFilterContext.filter),
      _useState6 = _slicedToArray(_useState5, 2),
  ...
  var onApply = useCallback(function (_ref8) {
    var filter = _ref8.filter,
        hide = _ref8.hide;
    currentFilterContext.setFilter(filter);
    hide();
  }, [currentFilterContext]);
  var onCancel = useCallback(function (_ref9) {
    var hide = _ref9.hide;
    hide();
  }, []);
  var onFilterChange = useCallback(function (filter) {
    setFilter(filter);
  }, []);
  return jsx(Popover, {
...
function PopupContent$1(_ref) {
  ...
  return React.createElement(UncontrollableFilter, {
    onApply: _onApply,
    onCancel: _onCancel,
    ...
    var helpVisible = _ref2.helpVisible,
        ...
        summaryProps = _ref2.summaryProps,
        footerProps = _ref2.footerProps;
    return React.createElement(React.Fragment, null, React.createElement(SummaryBar, summaryProps), React.createElement(FilterBody, null, React.createElement("form", {
      id: formId,
      onSubmit: function onSubmit(e) {
        return e.preventDefault();
      }
    ...
    }))), React.createElement(Footer, _extends({}, footerProps, {
      onApply: function onApply() {
        return _onApply({
          filter: filter,
          hide: hide
...
var VocabularyFilter = function VocabularyFilter(_ref3) {
  ...
  var currentFilterContext = useContext(FilterContext);
  return React.createElement(VocabularyFilterPopover, {
    modal: true,
...
var VocabularyFilterPopover = function VocabularyFilterPopover(_ref5) {
  ...
  var _useState3 = useState(currentFilterContext.filter),
      _useState4 = _slicedToArray(_useState3, 2),
  ...
  var onApply = useCallback(function (_ref6) {
    var filter = _ref6.filter,
        hide = _ref6.hide;
    currentFilterContext.setFilter(filter);
    hide();
  }, [currentFilterContext]);
  var onCancel = useCallback(function (_ref7) {
    var hide = _ref7.hide;
    hide();
  }, []);
  var onFilterChange = useCallback(function (filter) {
  ...
  return React.createElement(Popover, {
    ...
    return vocabulary && React.createElement(PopupContent$1, {
...
var Trigger = React.forwardRef(function (_ref9, ref) {
  ...
  if (!vocabulary) return React.createElement(Button, {
    appearance: "primaryOutline",
    ref: ref,
    loading: true
  }, "Loading");
...
var TablePresentation = function TablePresentation(_ref2) {
  ...
  var headers = [React.createElement(Th, {
    key: "scientificName",
    width: "wide",
    locked: fixedColumn,
    ...
    grow: false
  }, "scientificName"), React.createElement(Col, null, React.createElement(TaxonFilterPopover, {
    modal: true
  ...
  }, React.createElement(MdFilterList, null)))))), React.createElement(Th, {
    key: "year"
    ...
    grow: false
  }, "Basis of record"), React.createElement(Col, null, React.createElement(VocabularyFilterPopover, {
    modal: true
  }, React.createElement(Button, {
    appearance: "text",
    style: {
    ...
    key: "datasetTitle",
    width: "wide"
  }, "datasetTitle"), React.createElement(Th, {
    key: "publisherTitle",
    width: "wide"
  }, "publisherTitle"), React.createElement(Th, {
    key: "countryCode"
  }, "countryCode"), React.createElement(Th, {
    key: "gbifTaxonRank"
  }, "rank")];
  ...
  }), React.createElement("thead", null, React.createElement("tr", null, headers)), React.createElement(TBody, {
    rowCount: size,
    columnCount: 7,
    loading: loading
  }, getRows({
...
function (_Component) {
  ...
  _createClass(Table, [{
    ...
    key: "render",
    value: function render() {
      return React.createElement(TablePresentation, {
...
var GalleryPresentation = function GalleryPresentation(_ref) {
  ...
  if (!hits) return React.createElement("div", null, "no content");
  ...
  return React.createElement(Gallery, {
    caption: function caption(_ref2) {
      var item = _ref2.item;
      return React.createElement(GalleryCaption, null, item._source.gbifClassification.usage.name);
    },
    ...
    details: function details(item) {
      return React.createElement("pre", null, JSON.stringify(item, null, 2));
    },
...
function (_Component) {
  ...
  _createClass(Gallery, [{
    ...
    key: "render",
    value: function render() {
      return React.createElement(GalleryPresentation, {
...
var PopupContent$2 = function PopupContent(_ref) {
  ...
  return jsx(UncontrollableFilter, {
    ...
    var filter = _ref2.filter,
        ...
        summaryProps = _ref2.summaryProps,
        footerProps = _ref2.footerProps;
    return jsx(React.Fragment, null, jsx(Suggest, _extends({}, suggestConfig, {
      focusRef: focusRef,
      onKeyPress: function onKeyPress(e) {
        return e.which === keyCodes.ENTER ? _onApply(filter) : null;
      },
...
function SuggestFilterPopover(_ref4) {
  ...
  var onApply = useCallback(function (_ref5) {
    var filter = _ref5.filter,
        hide = _ref5.hide;
    currentFilterContext.setFilter(filter);
    hide();
  }, [currentFilterContext]);
  var onCancel = useCallback(function (_ref6) {
    var hide = _ref6.hide;
    hide();
  }, []);
  var onFilterChange = useCallback(function (filter) {
  ...
  _createClass(Standalone, [{
    ...
    value: function render() {
      ...
      return React.createElement(IntlProvider, {
        ...
        value: lightTheme
      }, React.createElement(OccurrenceSearch, {
        style: style
      })));
    }
  }]);
...
export { Standalone as OccurrenceSearch, Root };
