...
import { BasicField, CustomValueField, EnumField, HtmlField, PlainTextField } from './properties';
...
function Summary({ showAll, termMap, occurrence, setActiveImage }) {
  return (
    <Group label="occurrenceDetails.groups.summary">
      <Properties css={css.properties} breakpoint={800}>
        ...
        {occurrence.gbifClassification?.classification?.length > 1 && (
...
function Record({ showAll, termMap, occurrence, setActiveImage }) {
  return (
    <Group label="occurrenceDetails.groups.record">
      <Properties css={css.properties} breakpoint={800}>
...
function Occurrence({ showAll, termMap, occurrence, setActiveImage }) {
  ...
  return (
    <Group label="occurrenceDetails.groups.occurrence">
      <Properties css={css.properties} breakpoint={800}>
...
function Organism({ showAll, termMap, occurrence, setActiveImage }) {
  ...
  return (
    <Group label="occurrenceDetails.groups.organism">
      <Properties css={css.properties} breakpoint={800}>
...
function MaterialSample({ showAll, termMap, occurrence, setActiveImage }) {
  ...
  return (
    <Group label="occurrenceDetails.groups.materialSample">
      <Properties css={css.properties} breakpoint={800}>
...
function Event({ showAll, termMap, occurrence, setActiveImage }) {
  ...
  return (
    <Group label="occurrenceDetails.groups.event">
      <Properties css={css.properties} breakpoint={800}>
...
function Location({ showAll, termMap, occurrence, setActiveImage }) {
  ...
  return (
    <Group label="occurrenceDetails.groups.location">
      <Properties css={css.properties} breakpoint={800}>
...
function GeologicalContext({ showAll, termMap, occurrence, setActiveImage }) {
  ...
  return (
    <Group label="occurrenceDetails.groups.geologicalContext">
      <Properties css={css.properties} breakpoint={800}>
...
function Identification({ showAll, termMap, occurrence, setActiveImage }) {
  ...
  return (
    <Group label="occurrenceDetails.groups.identification">
      <Properties css={css.properties} breakpoint={800}>
...
function Taxon({ showAll, termMap, occurrence, setActiveImage }) {
  ...
  return (
    <Group label="occurrenceDetails.groups.taxon">
      <Properties css={css.properties} breakpoint={800}>
...
function Other({ showAll, termMap, occurrence, setActiveImage }) {
  ...
  return (
    <Group label="occurrenceDetails.groups.other">
      <Properties css={css.properties} breakpoint={800}>
...
function Citation({ occurrence }) {
  return (
    <Group label="phrases.citation">
      <Properties css={css.properties} breakpoint={800}>
        <T>
          <FormattedMessage id={`phrases.citeAs`} />
        </T>
        <V>
...
function Images({ occurrence, setActiveImage }) {
  ...
  return (
    <>
      <T>
        <FormattedMessage id={`occurrenceFieldNames.images`} defaultMessage={'Images'} />
      </T>
      <div>
        <V>
          <GalleryTiles>
