...
class Map extends Component {
  ...
  componentDidMount() {
    ...
    this.map = new mapboxgl.Map({
      ...
      zoom:
        ...
        this.props.defaultMapSettings?.zoom ||
        0,
      center: [
        sessionStorage.getItem('mapLng') ||
          this.props.defaultMapSettings?.lng ||
          0,
        sessionStorage.getItem('mapLat') ||
          this.props.defaultMapSettings?.lat ||
          0,
      ],
    });
    this.map.addControl(
  ...
  addLayer() {
    ...
    if (!this.mapLoaded) {
      ...
      map.on('click', (e) => {
        if (!e._defaultPrevented && this.props.onMapClick)
