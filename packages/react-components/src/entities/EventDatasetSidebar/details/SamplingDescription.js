...
export function SamplingDescription({
  ...
  return data?.dataset?.samplingDescription ? (
    <Accordion summary="Sampling" defaultOpen={true}>
        <Properties
    ...
    >
      ...
      <T><FormattedMessage id={`dataset.samplingDescription.studyExtent`} defaultMessage="Study extent"/></T>
      <V><HyperText text={dataset.samplingDescription.studyExtent} /></V></>
      }
      {dataset.samplingDescription?.qualityControl && <>
      <T><FormattedMessage id={`dataset.samplingDescription.qualityControl`} defaultMessage="Quality control"/></T>
      ...
      <T><FormattedMessage id={`dataset.samplingDescription.methodSteps`} defaultMessage="Method steps"/></T>
      <V>
