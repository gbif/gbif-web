...
function reduce(item) {
  ...
  const verbatim = removeUndefined({
    ...
    associatedOccurrences:              sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/associatedOccurrences'],
    ...
    earliestAgeOrLowestStage:           sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/earliestAgeOrLowestStage'],
    earliestEonOrLowestEonothem:        sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/earliestEonOrLowestEonothem'],
    earliestEpochOrLowestSeries:        sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/earliestEpochOrLowestSeries'],
    earliestEraOrLowestErathem:         sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/earliestEraOrLowestErathem'],
    earliestPeriodOrLowestSystem:       sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/earliestPeriodOrLowestSystem'],
    ...
    georeferenceVerificationStatus:     sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/georeferenceVerificationStatus'],
    ...
    highestBiostratigraphicZone:        sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/highestBiostratigraphicZone'],
    identificationID:                   sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/identificationID'],
    identificationQualifier:            sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/identificationQualifier'],
    identificationReferences:           sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/identificationReferences'],
    identificationRemarks:              sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/identificationRemarks'],
    identificationVerificationStatus:   sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/identificationVerificationStatus'],
    ...
    latestAgeOrHighestStage:            sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/latestAgeOrHighestStage'],
    latestEonOrHighestEonothem:         sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/latestEonOrHighestEonothem'],
    latestEpochOrHighestSeries:         sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/latestEpochOrHighestSeries'],
    latestEraOrHighestErathem:          sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/latestEraOrHighestErathem'],
    latestPeriodOrHighestSystem:        sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/latestPeriodOrHighestSystem'],
    lithostratigraphicTerms:            sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/lithostratigraphicTerms'],
    ...
    lowestBiostratigraphicZone:         sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/lowestBiostratigraphicZone'],
    ...
    pointRadiusSpatialFit:              sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/pointRadiusSpatialFit'],
    previousIdentifications:            sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/previousIdentifications'],
    ...
    reproductiveCondition:              sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/reproductiveCondition'],
    ...
    scientificNameAuthorship:           sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/scientificNameAuthorship'],
    ...
    verbatimCoordinateSystem:           sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/verbatimCoordinateSystem'],
    ...
    verbatimIdentification:             sourceVerbatim.core['http://rs.tdwg.org/dwc/terms/verbatimIdentification'],
